...
jCols2 <- c("#1E88E5","#FF5252","#00C853","#AB47BC","#FFAB00","#00B8D4","#F06292","#69F0AE","#9575CD","#EF6C00")

# Custom theme for ggthemr:
jPalette <- define_palette(
	swatch = c("#757575","#1E88E5","#FF5252","#00C853","#AB47BC","#FFAB00","#00B8D4","#F06292","#69F0AE","#9575CD","#EF6C00"),
